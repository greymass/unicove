...
>
	...
	<nav class="flex flex-col justify-center gap-1 text-nowrap text-base font-medium text-white/50">
		{#if context.account}
			{#each options as option}
				<a href={option.href} class="flex h-12 items-center">
					<span
						class="border-b-2 border-transparent py-1"
