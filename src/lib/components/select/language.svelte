...
<button
	class=" border-outline-variant focus:border-primary flex h-10 cursor-pointer items-center justify-between gap-2 rounded-full border-2 bg-transparent py-2 pr-3 pl-4 font-medium transition-opacity hover:opacity-90 focus:outline-none"
	use:melt={$trigger}
