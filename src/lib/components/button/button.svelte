<script lang="ts">
	...
	const textStyles =
		'inline-flex h-10  rounded-lg px-3  text-primary    focus-visible:outline-hidden focus-visible:text-solar-500 disabled:text-mine-400  disabled:hover:bg-transparent';
