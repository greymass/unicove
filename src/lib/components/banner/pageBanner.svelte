...
{#if showBanner}
	<aside
		class="grid grid-cols-[auto_1fr_auto] items-center justify-items-center gap-4 bg-linear-to-r from-[#1C2399] to-[#2E3BFF] text-on-surface shadow-lg *:row-start-1"
	>
		<a
			class="col-start-2 py-4 text-on-surface underline underline-offset-4 md:col-span-3 md:col-start-1 md:text-center"
