...
<Stack>
	<div>
		<div class="rounded-t-lg bg-mine-shaft-950 px-4 py-3 md:rounded-l-lg">
		...
		<div class="overflow-x-auto rounded-b-lg bg-mine-shaft-950/50 px-4 py-3 md:rounded-r-lg">
			<form onsubmit={query}>
