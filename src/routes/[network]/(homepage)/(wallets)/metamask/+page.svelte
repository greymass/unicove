...
<section class="col-span-full @container">
	<div class="grid min-h-72 rounded-2xl bg-mine-950 px-4 @2xl:grid-cols-2 @2xl:gap-4">
		<div class="grid place-items-center">
			...
			>
				<img
					class="h-40 rounded-full bg-mine-950 object-contain"
					src={Metamask}
					alt="metamask"
				/>
				...
				<img
					class="h-40 rounded-full bg-mine-950 object-contain px-2 py-4"
					src={networkLogo}
					alt={networkName}
				/>
			</div>
